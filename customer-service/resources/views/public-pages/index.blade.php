        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form method="POST" action="{{ route('complaints.store.authenticated') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-end space-x-4">
                    <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200">Buat Komplain</button>
                </div>
            </form>
            @else
            ...
            <div class="text-center py-12 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div class="mt-6 pt-6 border-t border-blue-200">
                    ...
                    <div class="flex justify-center">
                        <a href="https://wa.me/081234567890" target="_blank" class="text-green-600 hover:text-green-700 font-medium">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="bg-gradient-to-br from-blue-600 to-blue-800 p-12 flex items-center justify-center">
                    <div class="text-center text-white">
                        ...
                        <div class="space-y-4">
                            <a href="https://wa.me/081234567890" target="_blank" 
                               class="block bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200">
                                📱 WhatsApp: 081234567890
                            </a>
                            <a href="mailto:cs@karunialaris.com" 
                               class="block bg-white text-blue-600 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold transition-colors duration-200">
                                ✉️ Email: cs@karunialaris.com
                            </a>
                        </div>
                    </div>
                </div>
