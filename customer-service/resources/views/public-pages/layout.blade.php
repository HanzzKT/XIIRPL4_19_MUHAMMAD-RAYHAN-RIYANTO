                ...
                <div>
                    ...
                    <div class="space-y-2 text-gray-300">
                        <p class="flex items-start">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://wa.me/6281388556335" target="_blank" class="hover:text-white transition-colors duration-200">0813-8855-6335</a>
                        </p>
                        <p class="flex items-start">
                        ...
                        <p class="flex items-start">
                            ...
                            Jl. Raya Pekayon No.50, RT.004/RW.001, Jaka Setia, Kec. Bekasi Sel., Kota Bks, Jawa Barat
                        </p>
                    </div>
                </div>
                <div>
